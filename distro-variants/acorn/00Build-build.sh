...
# Variant-native Stage 00 ISO assembly hook for AcornOS.
...
ISO_PATH="${ISO_PATH:-${STAGE_OUTPUT_DIR}/acornos-s00_build.iso}"
...
set -- \
    ...
    --build-uki "AcornOS:video=1920x1080:acornos-live.efi" \
    --build-uki "AcornOS (Emergency):emergency:acornos-emergency.efi" \
    --build-uki "AcornOS (Debug):debug:acornos-debug.efi"
