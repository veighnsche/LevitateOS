...
# Variant-native Stage 00 ISO assembly hook for IuppiterOS.
...
ISO_PATH="${ISO_PATH:-${STAGE_OUTPUT_DIR}/iuppiter-x86_64-s00_build.iso}"
...
set -- \
    ...
    --build-uki "IuppiterOS::iuppiter-live.efi" \
    --build-uki "IuppiterOS (Emergency):emergency:iuppiter-emergency.efi" \
    --build-uki "IuppiterOS (Debug):debug:iuppiter-debug.efi"
